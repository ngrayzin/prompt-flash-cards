...
export default function QuizProgress({ progress, correctAnswers, answeredCount, totalCards, highScore }: QuizProgressProps) {
    ...
    <div className="space-y-4">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="text-center">
          ...
          <p className="text-lg font-bold text-amber-700">{highScore}/{totalCards}</p>
        </div>
      </div>
